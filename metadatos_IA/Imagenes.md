...
Cuando le pedimos a una IA que modifique una imagen, estas generarán una nueva imagen en base a la imagen que tu le has pasado.
...
<details>
<summary><strong>Ver imagen</strong></summary>
...
<details>
<summary><strong>Metadatos de la imagen 📸</strong></summary>
...
| Focal Length | 5.6 mm |
| Maker Note Unknown Text | (Binary data 232 bytes) |
...
<details>
<summary><strong>Ver metadatos de la imagen 🖼️</strong> </summary>
...
| Image Size | 864x1184 |
| Megapixels | 1.0 |
| Thumbnail Image | (Binary data 5029 bytes) |
...
| Created Assertions Hash | (Binary data 32 bytes), (Binary data 32 bytes) |
| Title | image.png |
| Item 0 | (Binary data 1985 bytes) |
| Item 1 Pad | (Binary data 10932 bytes) |
| Item 2 | null |
| Item 3 | (Binary data 64 bytes) |
| C2PA Thumbnail Ingredient Salt | e4efdb2c20bc1ff69d3f2207ac100449 |
| C2PA Thumbnail Ingredient Type | image/jpeg |
| C2PA Thumbnail Ingredient Data | (Binary data 21682 bytes) |
...
| Active Manifest Url | self#jumbf=/c2pa/urn:c2pa:3ef72d8d-1839-4cbc-8cb4-fa7baf8c0d7b |
| Active Manifest Alg | sha256 |
| Active Manifest Hash | (Binary data 32 bytes) |
...
Al pasarle la imagen generada con Gemini, me ha detectado que ha sido generada con IA, aunque viendo la explicación y descripción de la imagen, da a entender que parece una imagen real.
